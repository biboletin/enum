...
enum HttpStatus: int
{
    ...
    /**
     * Resolve an HTTP status code to its corresponding enum case.
     * This method attempts to find the enum case that matches the given status code.
     * If no matching case is found, it returns the Unknown case.
     *
     * @param int $code The HTTP status code to resolve.
     *
     * @return self The corresponding enum case or Unknown if not found.
     */

    public static function resolve(int $code): self
    {
